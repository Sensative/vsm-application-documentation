...
### Input soundAlarmTimeoutMinutes (confirmed)

> - Size: 1 bytes
> - Translation factor: 1
> - Request current value: Send 82 (hex) on lora port 2
> - Update value to 1: Send 82 00 00 00 01 (hex) on lora port 2
> - *Note: It is highly recommended to ensure that you use higher level applications to update settings so that the correct version of this application is used as reference (these data may change or differ between sensors)*
> - Unit: minutes
> - Default: 5
> - Max: 126
...
sound alarm is set and then held high for this number of minutes. During this time the sound alarm will not retrigger or reset.
...
M input soundAlarmTimeoutMinutes 130 0x82  1
