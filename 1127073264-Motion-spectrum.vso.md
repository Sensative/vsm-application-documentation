...
The module reports motion spectrum values when they have changed (but not when the device stops moving - which would otherwise just report a bunch of zeros and increase the data use)
