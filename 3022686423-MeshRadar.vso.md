...
The amplitude value reported by the radar in zone 2, uplinked when zone 1 values are triggered
...
The distance value reported by the radar in zone 2, uplinked when zone1 values are triggered
Unit of this is meters, resolution is 0.01 m.
...
### Output radarDetectionPercentageDay (confirmed)
...
detections per day than if there is no precipitation.
