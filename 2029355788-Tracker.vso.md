...
This is a general-purpose motion-triggered tracking application. 
It can do tracking both on set intervals when moving or when still.
Satellite (GPS and Beidou) and WIFI can both be sources for tracking.
